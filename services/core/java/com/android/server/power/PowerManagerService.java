...
public final class PowerManagerService extends SystemService
    ...
    private boolean mDozeOnNotification;
    ...
    public void systemReady(IAppOpsService appOps) {
        ...
        resolver.registerContentObserver(Settings.System.getUriFor(
                ...
                false, mSettingsObserver, UserHandle.USER_ALL);
        resolver.registerContentObserver(Settings.System.getUriFor(
                Settings.System.AMBIENT_NOTIFICATION_LIGHT_ACTIVATED),
                false, mSettingsObserver, UserHandle.USER_ALL);
    ...
    private void updateSettingsLocked() {
        ...
        if (mAmbientLights) {
                mDozeOnNotification = Settings.System.getIntForUser(resolver,
                Settings.System.AMBIENT_NOTIFICATION_LIGHT, 0, UserHandle.USER_CURRENT) != 0;
                Settings.System.putIntForUser(mContext.getContentResolver(),
                Settings.System.AMBIENT_NOTIFICATION_LIGHT_ACTIVATED, mDozeOnNotification ? 1 : 0,
                UserHandle.USER_CURRENT);
        }
