...
public class NotificationLightsView extends RelativeLayout {
    ...
    public NotificationLightsView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (DEBUG) Log.e("NotificationLightsView", "new");
    }

    private Runnable mLightUpdate = new Runnable() {
        @Override
        public void run() {
            if (DEBUG) Log.e("NotificationLightsView", "run");
    ...
    public void draw(Canvas canvas) {
        super.draw(canvas);
        if (DEBUG) Log.e("NotificationLightsView", "draw");
        //post(mLightUpdate);
    }
    ...
    public void animateNotification(boolean mNotification) {
        ...
        if (DEBUG) Log.e("NotificationLightsView", sb.toString());
        ...
        mLightAnimator.addUpdateListener(new AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                if (DEBUG) Log.e("NotificationLightsView", "onAnimationUpdate");
        ...
        if (DEBUG) Log.e("NotificationLightsView", "start");
