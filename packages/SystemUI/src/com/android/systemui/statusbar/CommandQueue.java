...
public class CommandQueue extends IStatusBar.Stub implements CallbackController<Callbacks>,
    ...
    private static final int MSG_SET_BLOCKED_GESTURAL_NAVIGATION   = 97 << MSG_SHIFT;
    private static final int MSG_SCREEN_PINNING_STATE_CHANGED      = 98 << MSG_SHIFT;
    private static final int MSG_LEFT_IN_LANDSCAPE_STATE_CHANGED   = 99 << MSG_SHIFT;
