...
public class NavigationModeController implements Dumpable {
    ...
    private final class AOSIPSettingsObserver extends ContentObserver {
        public AOSIPSettingsObserver(Handler handler) {
            super(handler);
        }
    ...
    private AOSIPSettingsObserver mSettingsObserver;
    ...
    public NavigationModeController(Context context,
        ...
        mSettingsObserver = new AOSIPSettingsObserver(new Handler());
