...
public interface StatusBarIconController {
     ...
     */
    public static class IconManager implements DemoMode, AOSiPSettingsService.AOSiPSettingsObserver {
        ...
        protected StatusBarMobileView addMobileIcon(int index, String slot, MobileIconState state) {
            ...
            mGroup.addView(view, index, onCreateLayoutParams());
            Dependency.get(AOSiPSettingsService.class).addIntObserver(this, Settings.System.USE_OLD_MOBILETYPE);
