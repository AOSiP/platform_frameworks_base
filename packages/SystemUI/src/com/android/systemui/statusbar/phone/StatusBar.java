...
public class StatusBar extends SystemUI implements DemoMode,
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_CLOSE_SYSTEM_DIALOGS.equals(action)) {
                ...
                if (intent.hasExtra(aosipUtils.DISMISS_KEYGUARD_EXTRA_INTENT)) {
                    Intent launchIntent = (Intent) intent.getParcelableExtra(
                            aosipUtils.DISMISS_KEYGUARD_EXTRA_INTENT);
    ...
    protected void updateTheme() {
        ...
        ThemeUtils.handleDarkThemeEnablement(useDarkTheme, useBlackAFTheme);
    ...
    private class AOSiPSettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            if (uri.equals(Settings.System.getUriFor(
                ...
                ThemeUtils.unloadAccents(mContext);
                ThemeUtils.updateAccents(mContext);
