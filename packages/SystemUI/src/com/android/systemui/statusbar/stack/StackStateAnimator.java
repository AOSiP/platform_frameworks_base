...
public class StackStateAnimator {
    ...
    public static final int ANIMATION_DURATION_WAKEUP = 120;
    public static final int ANIMATION_DURATION_GO_TO_FULL_SHADE = 326;
    public static final int ANIMATION_DURATION_APPEAR_DISAPPEAR = 332;
    public static final int ANIMATION_DURATION_DIMMED_ACTIVATED = 100;
    public static final int ANIMATION_DURATION_CLOSE_REMOTE_INPUT = 120;
