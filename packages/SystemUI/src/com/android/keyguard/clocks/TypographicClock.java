...
public class TypographicClock extends TextView {
    ...
    public void onTimeChanged() {
        ...
        for (Annotation annotation : annotationArr) {
            if ("color".equals(annotation.getValue())) {
                colored.setSpan(new ForegroundColorSpan(mAccentColor), colored.getSpanStart(annotation), colored.getSpanEnd(annotation), 33);
            }
        }
    ...
    protected void onAttachedToWindow() {
        ...
        getContext().registerReceiverAsUser(mTimeChangedReceiver, 
                Process.myUserHandle(), filter, null, getHandler());
    }
