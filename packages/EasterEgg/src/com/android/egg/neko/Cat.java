...
public class Cat extends Drawable {
    ...
    public static final String[] CAT_NAMES = {"Tom","Mickey","Dustin","Max","Tiger","Joe","Misty",
      "Simba","Coco","Lucy","Bella","Milo","Gingeer","Tuffy","Misty","Jaason","Sooty","Alfie",
      "Shadow","Samantha","Fluffy","Whiskers","Kitty"};
