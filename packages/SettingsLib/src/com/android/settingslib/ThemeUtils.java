...
public class ThemeUtils {
    ...
    private String DARK_THEME_PACKAGES[] = { "com.android.system.theme.dark",
    ...
    private String BLACK_THEME_PACKAGES[] = { "com.android.system.theme.blackaf",
    ...
    public boolean canUseBlackAccent() {
        return !isUsingDarkTheme() && !isUsingBlackAFTheme();
    }

    private boolean isUsingDarkTheme() {
        return isOverlayEnabled(DARK_THEME_PACKAGES[0]);
    }

    private boolean isUsingBlackAFTheme() {
        return isOverlayEnabled(BLACK_THEME_PACKAGES[0]);
    }
