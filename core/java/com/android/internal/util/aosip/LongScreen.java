...
public class LongScreen {
    ...
    public LongScreen(Context context) {
        ...
        mLongScreenAvailable = resources.getBoolean(R.bool.config_haveHigherAspectRatioScreen);
    ...
    public void addApp(String packageName) {
        ...
        Settings.System.putString(mContext.getContentResolver(),
                Settings.System.LONG_SCREEN_APPS, String.join(",", mApps));
    }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System.getUriFor(
                    Settings.System.LONG_SCREEN_APPS), false, this,
                    UserHandle.USER_ALL);
        ...
        public void update() {
            ...
            String apps = Settings.System.getStringForUser(resolver,
                    Settings.System.LONG_SCREEN_APPS,
